...
//Create your Question more aka Class
...
let question0more = new Question(
...
let question1more = new Question(
    "What will the following code ouput: ",
...
let question2more = new Question(
    "What will the following code ouput: ",
...
let question3more = new Question(
    "What will the following code ouput: ",
    ...
    "Prints all of contents of app to the more and then writes them to GoT"
);

let question4more = new Question(
    "What will the following code ouput: ",
...
moreQuestions.push(question0more, question1more, question2more, question3more, question4more);
