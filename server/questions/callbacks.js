...
let callbacksQuestions = [];

//Create your Question callbacks aka Class
...
let question0callbacks = new Question(
...
let question1callbacks = new Question(
    "What will the following code ouput: ",
...
let question2callbacks = new Question(
    "What will the following code ouput: ",
...
let question3callbacks = new Question(
    "What will the following code ouput: ",
    ...
    "Prints all of contents of app to the callbacks and then writes them to GoT"
);

let question4callbacks = new Question(
    "What will the following code ouput: ",
...
callbacksQuestions.push(question0callbacks, question1callbacks, question2callbacks, question3callbacks, question4callbacks);

module.exports = callbacksQuestions;